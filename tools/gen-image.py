...
Usage:
  ...
  python3 tools/gen-image.py "prompt" -o out.png --size 1024x1536 --quality high --model gpt-image-1
...
STYLE = (
    ...
    "no text, no logos, no watermarks. Subtle cool navy and cyan tones."
)
